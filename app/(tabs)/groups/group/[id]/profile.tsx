/**
 * Perfil del grupo
 * Edición de avatar, nombre y datos visibles del grupo.
 */
  ...
  return (
    <View style={[styles.skeletonContainer, { paddingTop: insets.top + 8 }]}>
      ...
      <Animated.View entering={FadeInDown.duration(400).delay(360)}>
        <View
          style={[
            styles.skeletonSectionLabel,
            { backgroundColor: theme.colors.surfaceVariant },
          ]}
        />
        <View
          style={[
            styles.skeletonSettingsCard,
            { backgroundColor: theme.colors.surface },
          ]}
        />
      </Animated.View>
        ...
        >
          ...
          <Animated.View entering={FadeInDown.duration(400).delay(300)}>
            ...
            >
              ...
              >
                <SquircleView
                  style={[styles.settingsIconBg, { backgroundColor: iconBg }]}
                  cornerSmoothing={1}
                >
                  <Ionicons
                    name="text-outline"
          ...
          <Animated.View
            entering={FadeInDown.duration(400).delay(460)}
              ...
              onPress={() => {
                if (isOwner) {
                  if (transferableMembers.length === 0) {
                    showSnackbar(
                      "No hay otros miembros para transferir el grupo.",
                      "info",
                    );
                  } else {
                ...
                <View style={{ flex: 1 }}>
                  ...
                  >
                    {isOwner
                      ...
                      : "Perderás acceso al contenido privado"}
                  </Text>
                </View>
                <Ionicons
                  name="chevron-forward"
                  size={16}
                  color={
                    isOwner ? theme.colors.onSurfaceVariant : theme.colors.error
                  }
                />
              </SquircleView>
            </Pressable>
          ...
          <View style={styles.sheetContent}>
            ...
            {(myMembership?.group_avatar_url || profile?.avatar_url) && (
              ...
              >
                ...
                />
                <Text
                  style={[styles.actionRowText, { color: theme.colors.error }]}
                >

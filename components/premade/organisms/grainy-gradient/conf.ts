/**
 * Shader del gradiente
 * Código GLSL con colores, grano y animación del fondo granulado.
 */
...
// Hash rápido en lugar de Simplex 3D para el grano (más barato)
float hash(float2 p) {
...
// Movimiento con senos/cosenos en lugar de ruido 3D para el gradiente
